    ...
    <div className='relative h-screen flex items-center justify-center text-white overflow-hidden flex-col'>
      ...
      <div className='relative z-10 flex flex-col items-center'>
        ...
        <h1 data-aos="fade-up" data-aos-delay="200" className='text-2xl sm:text-4xl md:text-5xl lg:text-6xl mt-6 text-center font-bold tracking-wide'>
          ...
          <span className="text-cyan-200"> and AI/ML Solutions </span>
        </h1>
        <h2 data-aos="fade-up" data-aos-delay="400" className='mt-5 text-sm px-2 text-center sm:text-2xl md:text-3xl lg:text-4xl font-medium flex items-center gap-2'> {/**gap-2 */}
